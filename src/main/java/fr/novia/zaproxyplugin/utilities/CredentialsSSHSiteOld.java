...
public class CredentialsSSHSiteOld {
	...
	public static final Logger LOGGER = Logger.getLogger(CredentialsSSHSiteOld.class.getName());



	private CredentialsSSHSiteOld() {
	}
...
//	}
	...
	public CredentialsSSHSiteOld(final String hostname, final int port, final String username,final String password,final String serverAliveInterval, final String timeout) {
